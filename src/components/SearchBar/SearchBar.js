...
function SearchBar(props) {
 ...
 <div className="form-control">
      <div className="input-group justify-center mt-10 mb-10">
        <input type="text" placeholder="Search by title…" className="input input-bordered h-20 w-96 text-2xl" onChange={handleUserInput} value={userInput} />
        <button onClick={handleClick} className="btn btn-square  h-20 w-20">
